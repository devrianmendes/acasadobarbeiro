import bg1 from "../assets/imagem-de-fundo-1-a-casa-do-barbeiro.webp";
import bg2 from "../assets/imagem-de-fundo-2-a-casa-do-barbeiro.webp";
import bg3 from "../assets/imagem-de-fundo-3-a-casa-do-barbeiro.webp";
